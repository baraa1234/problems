...
(:objects
	...
	n32 - count
	(:private
		slow-6 - slow-elevator
		n27 - count
	)
)
(:init
	(lift-at slow-6 n24)
	(passengers slow-6 n0)
	(can-hold slow-6 n1)
	(can-hold slow-6 n2)
	(reachable-floor  slow-6 n24)
	(reachable-floor  slow-6 n25)
	(reachable-floor  slow-6 n26)
	(reachable-floor  slow-6 n27)
	(reachable-floor  slow-6 n28)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
