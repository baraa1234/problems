...
(:objects
	...
	n32 - count
	(:private
		slow-4 - slow-elevator
	)
)
(:init
	(lift-at slow-4 n16)
	(passengers slow-4 n0)
	(can-hold slow-4 n1)
	(can-hold slow-4 n2)
	(reachable-floor  slow-4 n16)
	(reachable-floor  slow-4 n17)
	(reachable-floor  slow-4 n18)
	(reachable-floor  slow-4 n19)
	(reachable-floor  slow-4 n20)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
