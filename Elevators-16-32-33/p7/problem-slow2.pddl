...
(:objects
	...
	n32 - count
	(:private
		slow-2 - slow-elevator
	)
)
(:init
	(lift-at slow-2 n8)
	(passengers slow-2 n0)
	(can-hold slow-2 n1)
	(can-hold slow-2 n2)
	(reachable-floor  slow-2 n8)
	(reachable-floor  slow-2 n9)
	(reachable-floor  slow-2 n10)
	(reachable-floor  slow-2 n11)
	(reachable-floor  slow-2 n12)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
