...
(:objects
	...
	n32 - count
	(:private
		slow-5 - slow-elevator
		n21 - count
	)
)
(:init
	(lift-at slow-5 n20)
	(passengers slow-5 n0)
	(can-hold slow-5 n1)
	(can-hold slow-5 n2)
	(reachable-floor  slow-5 n20)
	(reachable-floor  slow-5 n21)
	(reachable-floor  slow-5 n22)
	(reachable-floor  slow-5 n23)
	(reachable-floor  slow-5 n24)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
