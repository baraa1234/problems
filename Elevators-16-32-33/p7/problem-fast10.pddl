...
(:objects
	...
	n32 - count
	(:private
		fast-10 - fast-elevator
	)
)
(:init
	(lift-at fast-10 n0)
	(passengers fast-10 n0)
	(can-hold fast-10 n1)
	(can-hold fast-10 n2)
	(can-hold fast-10 n3)
	(reachable-floor  fast-10 n0)
	(reachable-floor  fast-10 n4)
	(reachable-floor  fast-10 n8)
	(reachable-floor  fast-10 n12)
	(reachable-floor  fast-10 n16)
	(reachable-floor  fast-10 n20)
	(reachable-floor  fast-10 n24)
	(reachable-floor  fast-10 n28)
	(reachable-floor  fast-10 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
