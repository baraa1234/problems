...
(:init
	...
	(can-hold slow-2 n1)
	(can-hold slow-2 n2)
	(reachable-floor  slow-2 n16)
	(reachable-floor  slow-2 n17)
	(reachable-floor  slow-2 n18)
	(reachable-floor  slow-2 n19)
	(reachable-floor  slow-2 n20)
	(reachable-floor  slow-2 n21)
	(reachable-floor  slow-2 n22)
	(reachable-floor  slow-2 n23)
	(reachable-floor  slow-2 n24)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
