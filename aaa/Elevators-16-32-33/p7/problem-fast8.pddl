...
(:objects
	...
	n32 - count
	(:private
		fast-8 - fast-elevator
	)
)
(:init
	(lift-at fast-8 n0)
	(passengers fast-8 n0)
	(can-hold fast-8 n1)
	(can-hold fast-8 n2)
	(can-hold fast-8 n3)
	(reachable-floor  fast-8 n0)
	(reachable-floor  fast-8 n4)
	(reachable-floor  fast-8 n8)
	(reachable-floor  fast-8 n12)
	(reachable-floor  fast-8 n16)
	(reachable-floor  fast-8 n20)
	(reachable-floor  fast-8 n24)
	(reachable-floor  fast-8 n28)
	(reachable-floor  fast-8 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
