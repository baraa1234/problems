...
(:objects
	...
	n32 - count
	(:private
		slow-7 - slow-elevator
		n30 - count
	)
)
(:init
	(lift-at slow-7 n28)
	(passengers slow-7 n0)
	(can-hold slow-7 n1)
	(can-hold slow-7 n2)
	(reachable-floor  slow-7 n28)
	(reachable-floor  slow-7 n29)
	(reachable-floor  slow-7 n30)
	(reachable-floor  slow-7 n31)
	(reachable-floor  slow-7 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
