...
(:objects
	...
	n32 - count
	(:private
		fast-13 - fast-elevator
	)
)
(:init
	(lift-at fast-13 n0)
	(passengers fast-13 n0)
	(can-hold fast-13 n1)
	(can-hold fast-13 n2)
	(can-hold fast-13 n3)
	(reachable-floor  fast-13 n0)
	(reachable-floor  fast-13 n4)
	(reachable-floor  fast-13 n8)
	(reachable-floor  fast-13 n12)
	(reachable-floor  fast-13 n16)
	(reachable-floor  fast-13 n20)
	(reachable-floor  fast-13 n24)
	(reachable-floor  fast-13 n28)
	(reachable-floor  fast-13 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
