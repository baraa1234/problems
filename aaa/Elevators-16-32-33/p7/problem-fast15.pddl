...
(:objects
	...
	n32 - count
	(:private
		fast-15 - fast-elevator
	)
)
(:init
	(lift-at fast-15 n0)
	(passengers fast-15 n0)
	(can-hold fast-15 n1)
	(can-hold fast-15 n2)
	(can-hold fast-15 n3)
	(reachable-floor  fast-15 n0)
	(reachable-floor  fast-15 n4)
	(reachable-floor  fast-15 n8)
	(reachable-floor  fast-15 n12)
	(reachable-floor  fast-15 n16)
	(reachable-floor  fast-15 n20)
	(reachable-floor  fast-15 n24)
	(reachable-floor  fast-15 n28)
	(reachable-floor  fast-15 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
