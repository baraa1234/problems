...
(:objects
	...
	n32 - count
	(:private
		fast-14 - fast-elevator
	)
)
(:init
	(lift-at fast-14 n0)
	(passengers fast-14 n0)
	(can-hold fast-14 n1)
	(can-hold fast-14 n2)
	(can-hold fast-14 n3)
	(reachable-floor  fast-14 n0)
	(reachable-floor  fast-14 n4)
	(reachable-floor  fast-14 n8)
	(reachable-floor  fast-14 n12)
	(reachable-floor  fast-14 n16)
	(reachable-floor  fast-14 n20)
	(reachable-floor  fast-14 n24)
	(reachable-floor  fast-14 n28)
	(reachable-floor  fast-14 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
