...
(:objects
	...
	n32 - count
	(:private
		fast-11 - fast-elevator
	)
)
(:init
	(lift-at fast-11 n0)
	(passengers fast-11 n0)
	(can-hold fast-11 n1)
	(can-hold fast-11 n2)
	(can-hold fast-11 n3)
	(reachable-floor  fast-11 n0)
	(reachable-floor  fast-11 n4)
	(reachable-floor  fast-11 n8)
	(reachable-floor  fast-11 n12)
	(reachable-floor  fast-11 n16)
	(reachable-floor  fast-11 n20)
	(reachable-floor  fast-11 n24)
	(reachable-floor  fast-11 n28)
	(reachable-floor  fast-11 n32)
	(= (total-cost) 0)
	(above n0 n1)
	(above n0 n2)
	(above n1 n2)
